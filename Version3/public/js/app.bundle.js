...
(function () {
  ...
  // 완료된 할일 수 반환
  var countComplete = function countComplete() {
    var completCount = 0;
  ...
  var selectActive = function selectActive() {
  ...
  var addTodo = function addTodo(event) {
    _axios2.default.post('/todos', { id: getId(), content: event.target.value, completed: false }).then(function (_ref2) {
      var data = _ref2.data;
  ...
  var chkChange = function chkChange(event) {
    var _todos$find = todos.find(function (item) {
      return item.id === +event.target.id;
    }),
        completed = _todos$find.completed;

    _axios2.default.patch('/todos/id/' + event.target.id, { completed: !completed }) // payload: { completed }
    .then(function (_ref3) {
      var data = _ref3.data;
  ...
  var deleteCompleted = function deleteCompleted() {
    _axios2.default.delete('/todos/completed').then(function (_ref4) {
      var data = _ref4.data;
  ...
  var checkAll = function checkAll() {
    var compleData = void 0;
    if (countComplete() !== todos.length) {
      compleData = true;
    } else {
      compleData = false;
    }
    _axios2.default.patch('/todos', { completed: compleData }) // payload: { completed }
    .then(function (_ref5) {
      var data = _ref5.data;
  ...
  var deleteTodo = function deleteTodo(event) {
    _axios2.default.delete('/todos/id/' + event.target.dataset.id).then(function (_ref6) {
      var data = _ref6.data;
      return console.log('[[DELETE COMPLETED]]', todos);
    }).catch(function (err) {
      return console.log(err);
    });
  };
